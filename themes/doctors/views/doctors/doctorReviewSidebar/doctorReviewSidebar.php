...
<!-- 	<div class="badges">
 ...
 -->
	<?php if( ( $doctor->soc_twitter != '' ) || ( $doctor->soc_facebook != '' ) || ( $doctor->soc_linkedin != '' ) || ( $doctor->soc_google != '' ) ): ?>
	<h3>Follow This Doctor</h3>	
	<ul class="social1">
        <?php if( $doctor->soc_twitter != '' ):?>	
		<li><a href="<?php echo $doctor->soc_twitter; ?>" class="twitter">&#32;</a></li>
        <?php endif;?>
        <?php if( $doctor->soc_facebook != '' ):?>	
		<li><a href="<?php echo $doctor->soc_facebook; ?>" class="fb">&#32;</a></li>
        <?php endif;?>
        <?php if( $doctor->soc_linkedin != '' ):?>	
		<li><a href="<?php echo $doctor->soc_linkedin; ?>" class="linkedin">&#32;</a></li>
        <?php endif;?>
        <?php if( $doctor->soc_google != '' ):?>	
		<li><a href="<?php echo $doctor->soc_google; ?>" class="google">&#32;</a></li>
        <?php endif;?>
	</ul>
    <?php endif;?>
