...
<?php include_once('_links.php'); ?>
    ...
    <fieldset class="leftalign">
        ...
        <dl class="float_left">
            ...
            <dd>
                <?php echo $form->textField( $doctor, 'soc_twitter', array( 'class'=>'textbox textbox4' )); ?>
        ...
        <dt><label>FACEBOOK:</label></dt>
            <dd>
                <?php echo $form->textField( $doctor, 'soc_facebook', array( 'class'=>'textbox textbox4' )); ?>
        ...
        <dt><label>LINKEDIN:</label></dt>
            <dd>
                <?php echo $form->textField( $doctor, 'soc_linkedin', array( 'class'=>'textbox textbox4' )); ?>
        ...
        <dt><label>GOOGLE PLUS:</label></dt>
            <dd>
                <?php echo $form->textField( $doctor, 'soc_google', array( 'class'=>'textbox textbox4' )); ?>
