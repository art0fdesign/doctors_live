...
<!-- 
 ...
 -->
	...
	<?php if( ( $model->soc_twitter != '' ) || ( $model->soc_facebook != '' ) || ( $model->soc_linkedin != '' ) || ( $model->soc_google != '' ) ): ?>
	<h3>Follow This Doctor</h3>	
	<ul class="social1">
        <?php if( $model->soc_twitter != '' ):?>	
		<li><a href="<?php echo $model->soc_twitter; ?>" class="twitter">&#32;</a></li>
        <?php endif;?>
        <?php if( $model->soc_facebook != '' ):?>	
		<li><a href="<?php echo $model->soc_facebook; ?>" class="fb">&#32;</a></li>
        <?php endif;?>
        <?php if( $model->soc_linkedin != '' ):?>	
		<li><a href="<?php echo $model->soc_linkedin; ?>" class="linkedin">&#32;</a></li>
        <?php endif;?>
        <?php if( $model->soc_google != '' ):?>	
		<li><a href="<?php echo $model->soc_google; ?>" class="google">&#32;</a></li>
        <?php endif;?>
	</ul>
    <?php endif;?>
