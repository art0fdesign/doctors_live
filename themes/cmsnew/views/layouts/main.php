...
<?php if( $frontendTheme == 'doctors' ): ?>
            ...
            <li <? if($module == 'doctorRatings' && in_array( $controler, $filterArray )) echo "class='active'";?>><?php echo CHtml::link('Ratings<span>Ratings panel</span>', '#', array('class'=>'exp accordionButton admin')) ?>
            ...
            <li <? if( in_array( $module, array( 'doctor', 'doctorRatings')) && in_array( $controler, $filterArray )) echo "class='active'";?>><?php echo CHtml::link('Settings<span>Settings panel</span>', '#', array('class'=>'exp accordionButton admin')) ?>
                <ul class="menu1 accordionContent <? if( in_array( $module, array( 'doctor', 'doctorRatings')) && in_array( $controler, $filterArray ) ) echo "acc-on";?>">
                    ...
                    <li><?php echo CHtml::link('News List', array('/doctors/news')) ?></li>
                    <li><?php echo CHtml::link('Blog List', array('/blog/blog')) ?></li>
...
<?php /** ======================================  ADMIN =========================================================== */?>
            ...
            <li <?php if(in_array($controler,array('modRegister','template','user'))) echo "class='active'";?>><?php echo CHtml::link('Admin<span>Administrators panel</span>', '#', array('class'=>'exp accordionButton admin')) ?>
